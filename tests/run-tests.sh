...
#   ./tests/run-tests.sh /opt/tlog_lib/tests/01-tlog.bats  # Specific file
#
# Supported OS values:
...
case "$OS" in
	...
	*)
		echo "Unknown OS: $OS"
		echo "Supported: debian12, rocky9, centos6"
		exit 1
		;;
esac
...
IMAGE_NAME="tlog-test-${OS}"

echo "Building tlog_lib test image ($OS)..."
...
for i in $(seq 0 $(( NUM_FILES - 1 ))); do
	...
	container_path="/opt/tlog_lib/tests/$fname"
